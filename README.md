...
Версия 0.6.0 включает этапы 0–6: редактор параметров и отказов, ревизии, сравнение A/B с общим временем и камерой, глобус/карта/топология, N−1, рекомендации и автоподбор сочетаний с полным пересчётом и границей Парето. Светлая и тёмная темы переключаются кнопкой в шапке. Внешняя публикация остаётся задачей выпуска. [Статус и следующие этапы](docs/ROADMAP.md).
...
[Как использовать автоподбор](docs/AUTOPICK.md): настройки поиска, воспроизводимый seed, критерии Парето и проверка выбранного варианта.
