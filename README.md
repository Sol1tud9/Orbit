# Орбита · Лаборатория устойчивости
...
Это результат этапов 0–2. Редактор параметров, сравнение A/B, N−1 и доказательные рекомендации запланированы следующими этапами; текущий интерфейс позволяет загружать изменённые сценарии и хранить их расчёты. [Статус и следующие этапы](docs/ROADMAP.md).
